...
このタスクでは、作成した Log Analytics ワークスペースに Sentinel を追加します。
...
| ロール | アクセス許可 |
|---|---|
| セキュリティ アナリスト | データ、インシデント、ブック、その他の Sentinel リソースの表示、インシデントの割り当て/無視。 |
| セキュリティ エンジニア | ブックと分析ルールの作成と編集、コンテンツ ハブからのソリューションのインストールと更新 |
...
Contoso のセキュリティ運用チームのロール要件に対するロール ベースのアクセス モデルが正常に作成されました。
